  ...
  return (
    <>
      {!companyDetails ? (
        ...
        <>
          <h5 className="mt-2 mb-3 fw-medium">Company Details</h5>
          <Table bordered>
            <thead>
              <tr>
                ...
                <th className="tableHeadingBg-color text-white">URL</th>
                <th className="tableHeadingBg-color text-white">Edit</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="primary-text-color">{companyDetails?.name}</td>
                <td>
